...
{
    /// <summary>UV抽液参数</summary>
    internal class PLC_UVAspirateParam : PLC_SemiAutoParamBase
    {
        ...
        /// <param name="syringeAcc">加减速时间</param>
        ...
        public PLC_UVAspirateParam(
             int z, int syringeSpeed, int syringeAcc,
            int zPurgeUpPulse, int zPurgeDownPulse, int zBackPulse,
            int zOffset, short ignoreSyringeSensor, short purgeCount, short syringeType)
            : base(PLC.SemiAutomaticOperation.UVAspirate)
        {
            ...
            : base(PLC.SemiAutomaticOperation.UVAspirate)
        {
            ...
            PurgeCount = new ProtocolItem(816, typeof(short), My_ConPar.Other.DrainCount);
            SyringeType = new ProtocolItem(817, typeof(short), syringeType);
        }
    }

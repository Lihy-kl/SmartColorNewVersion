...
{
    internal class ADT8940A1_Aspirate
    {
        /// <summary>
        /// 抽液
        /// </summary>
        ...
        public Task<int> Aspirate(int z, int purgeCount, short syringeType)
        {
            ...
            return Task.Run(() =>
            {
                try
                {
                    ...
                    while (true)
                    {
                        ...
                        else if (purgeCount == pCount) { break; }
                        //助剂时做下排空
                        //if (iIsAssitant == 1)
                        {
                            int iZRes1 = CardObject.OA1Axis.Absolute_Z(syringeType, SmartColor.My_ConPar.Other.Z_UpPulse, 0);
                            if (0 != iZRes1)
                                return iZRes1;

                            try
                            {
                                iZRes1 = CardObject.OA1Axis.Absolute_Z(syringeType, SmartColor.My_ConPar.Other.Z_DownPulse, 0);
                                if (0 != iZRes1)
                                    return iZRes1;
                            }
                            catch (Exception ex)

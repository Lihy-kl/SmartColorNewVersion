...
{
    internal class ADT8940A1_RobotHandGrasping
    {
        /// <summary>
        /// 机械手抓取（异步方法）
        /// </summary>
        ...
        public Task<int> RobotHandGraspingAsync(short graspType, short syringeType)
        {
            ...
            return Task.Run(() =>
            {
                try
                {
                    ...
                    getOrPutClamp.GetClamp(SmartColor.My_ConPar.Hardware.CylinderType);
                }
                catch (Exception ex)
                {
